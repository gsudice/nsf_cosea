...
"""
internet_df = pd.read_sql(internet_query, engine)
internet_df['geoid'] = internet_df['geoid'].astype(str).str.zfill(12)
internet_df['households_with_subscription'] = pd.to_numeric(
    internet_df['households_with_subscription'], errors='coerce'
)
...
fig.savefig("output_394/map11_county_394.png", dpi=300,

...
edu_df = pd.read_sql(edu_query, engine)
edu_df['geoid'] = edu_df['geoid'].astype(str).str.zfill(12)
edu_df['edu_hs_or_more'] = pd.to_numeric(
    edu_df['edu_hs_or_more'], errors='coerce')
...
fig.savefig("output_394/map10_county_394.png", dpi=300,

...
JOIN "allhsgrades24"."tbl_approvedschools" s ON g."UNIQUESCHOOLID" = s."UNIQUESCHOOLID"
...
pop_df['asian_ratio'] = pop_df['asian_alone_non_hispanic'] / \
...
"""
block_groups = gpd.read_postgis(block_groups_query, engine, geom_col='geom')
...
# save figure
fig.savefig("output_394/map4_county_394.png", dpi=300,

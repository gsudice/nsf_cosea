...
"""
school_gdf = gpd.read_postgis(query, engine, geom_col='geom')

# convert disparity column to numeric
...
# load Black population ratios from ACS
pop_sql = """
SELECT geoid, black_alone_non_hispanic, total_population 
FROM census.acs2023_combined;
"""
pop_df = pd.read_sql(pop_sql, engine)  # use engine instead of conn
...
fig.savefig("output_394/map7_county_394.png", dpi=300,

...
block_query = """
SELECT "GEOID", ST_Transform(cbgpolygeom, 4326) AS geom FROM "allhsgrades24"."tbl_cbg"
"""
...
fig.savefig("/home/ctiwari/.conda/envs/cosea/_mycode/nsf_cosea/output/map11_county_389.png", dpi=300, bbox_inches='tight', bbox_extra_artists=[leg1, leg2, leg3])
#plt.show()

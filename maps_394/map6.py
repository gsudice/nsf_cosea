...
pop_df['white_ratio'] = pop_df['white_alone_non_hispanic'] / \
...
block_groups = block_groups.merge(
    pop_df[['geoid', 'white_ratio']], left_on='GEOID', right_on='geoid', how='left'
)
block_groups['white_ratio_class'] = pd.qcut(
    block_groups['white_ratio'], 5, labels=False, duplicates='drop')
...
fig.savefig("output_394/map6_county_394.png", dpi=300,
